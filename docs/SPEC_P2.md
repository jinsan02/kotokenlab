...
> **2026-09-17 종료.** 이 문서는 설계 시점(2026-09-03~07)의 기록이라 본문을 고치지
> 않는다. 결과: R1 부정 · Q7(R4) 구별 불가 · R5 긍정 · R2/R3 는 전제 상실로 P3-D 에
> 재설계 · 한자 프로브 D1~D3 예측 적중 — [`SCHEDULE_P2.md`](SCHEDULE_P2.md).
> §0 의 "65% 법칙" 서술은 R1 · R5 로 반증됐다. 이어지는 일은 [`SPEC_P3.md`](SPEC_P3.md).
