...
닫힌 것: Q1~Q5. 남은 것은 **Q6 (시스템 지표)** 와 Level 3 능력 평가다.
압축 -25~30% 가 prefill·TTFT·KV cache 에서 얼마로 나타나는지가 이 프로젝트에서
아직 측정하지 않은 마지막 축이고, **T2b 가 유일하게 이길 수 있는 축이다.**

새로 생긴 질문 하나 — **N 곡선이 강하게 오목하다.** N=0 은 정의상 C0(1.1375)
