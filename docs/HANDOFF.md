...
최종 갱신 2026-09-14 (**2차 W0 + Day 1 완료. R1 은 부정**). 1차 결과 전체는
...
**2차 Day 1 완료. R1 은 부정이다. 다음은 Day 2 = Q7 게이트.**
...
명령과 전제 조건은 [`SCHEDULE_P2.md` "Day 2"](SCHEDULE_P2.md) 에 그대로 있다.
2026-09-14 에 미리 확인해 둔 것:

```
산출물   untied 둘 다 텐서 291개 · lm_head.weight 있음 · tie=False
run_id   cpt_untied_{t2b_mean,c0_qwen}_q7g_seed{42,123,2026}  살균 통과
VRAM     12,205 MiB 예상 (오늘 R1 실측 11,382 + Day 0 스모크 823). 여유 4,098
프로브   --model / --out / --force 있다
```

약 2h 10m. **S0 전에 브라우저·Steam·Discord 를 닫는다.**
